...
MODEL_BUCKET_NAME = "my-model-mlopsproj-one"
MODEL_PUSHER_S3_KEY = "model-registry"  # s3 key is not actual key just model name (not even get use in our project we put model directly in bucket not in model-registry/model.pkl)
